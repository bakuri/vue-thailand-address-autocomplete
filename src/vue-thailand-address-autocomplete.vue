...
export default {
  ...
  methods: {
    ...
    itemFirst(address) {
      let districtPrefix =
        address['province'] == 'กรุงเทพมหานคร' ? 'แขวง : ' : 'ตำบล : '
      return this.type === 'district'
        ? '' + address['amphoe']
        : districtPrefix + address['district']
    },
    /**
     * - แสดงข้อมูลตรงกลางบน
     */
    ...
    itemSecond(address) {
      let districtPrefix =
        address['province'] == 'กรุงเทพมหานคร' ? 'เขต : ' : 'อำเภอ : '

      console.log(districtPrefix)
      return this.type === 'amphoe' || this.type === 'district'
        ? '' + address['province']
        : districtPrefix + address['amphoe']
    },
    /**
     * - แสดงข้อมูลขวาบน
     */
